...
Each [party](../glossary.md#party) member has the following slots:

| Slot | Description |
|------|-------------|
| **Weapon** | Required to play [attack cards](../glossary.md#attack-card). Determines attack type and scaling. |
| **Off-hand** | Secondary slot — shield for defence, or a secondary weapon for dual-wielding. |
| **Head** | Helmet or headgear. |
| **Chest** | Body armour. |
| **Hands** | Gloves. |
| **Feet** | Boots. |
| **Amulet** | Necklace slot. One amulet. |
