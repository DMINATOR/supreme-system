...
> Structured reference extracted from [equipment.md](equipment.md). Open questions: [equipment_tbd.md](equipment_tbd.md).
...
- Each slot holds exactly one equipment card
...
- Assign an equipment card to a slot (before combat)
- Unassign an equipment card from a slot (before combat)
